...
module.exports = {
    generate: function (sails, template, data, options, cb) {
      var pdfgen_obj = pdfgen(sails);
      // pdfgen_obj.initialize(cb);
      // pdfgen_obj.configure();
      pdfgen_obj.make(template, data, options, cb);
    },
};
